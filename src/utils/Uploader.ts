...
const api = axios.create({
  baseURL: "http://localhost:3000/drive/file",
  headers: {
    Authorization:
      "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjExZWE0YzM4LWI2OTktNDQzNy05YTQ0LThiM2UwMmEwMmM2NSIsImlhdCI6MTY4MDI2MzM4MCwiZXhwIjoxNjgwMzQ5NzgwfQ.34qZZPrYAc6D-Hgwr8jwLGpf_lO5Z57oMEbkQdmV5Uw",
...
export class Uploader {
  ...
  constructor(options: any) {
    ...
    this.fileId = null;
    this.fileKey = null;
    this.ContentType = options.fileType;
    this.onProgressFn = () => {};
    this.onErrorFn = () => {};
  }
